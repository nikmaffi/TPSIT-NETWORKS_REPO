...
int main(int argc, const char **argv, const char **envp)
{
    ...
    int song_index; //Indice delbrano che verrà scelto a random
    int num_line; //Numero di linee del file csv
    ...
    printsong(s, num_line, stdout); //Stampa sullo schermo delle canzoni in disordine
